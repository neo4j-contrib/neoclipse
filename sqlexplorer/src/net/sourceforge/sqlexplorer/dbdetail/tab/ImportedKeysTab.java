...
public class ImportedKeysTab extends AbstractDataSetTab {
    ...
    public String getLabelText() {
        return Messages.getString("DatabaseDetailView.Tab.ImportedKeys");
    }
    ...
    public String getStatusMessage() {
        return Messages.getString("DatabaseDetailView.Tab.ImportedKeys.status") + " " + getNode().getQualifiedName();
    }
}
