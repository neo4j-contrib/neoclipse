 ...
 */
public class CopyCellAction extends AbstractCopyAction {

    public CopyCellAction() {
		super(Messages.getString("DataSetTable.Actions.CopyCell"), ImageUtil.getDescriptor("Images.ExportToClipBoardIcon"));
	}
