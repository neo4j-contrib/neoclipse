 ...
 */
public class CopyRowAction extends AbstractCopyAction {

    public CopyRowAction() {
		super(Messages.getString("DataSetTable.Actions.CopyRow"), ImageUtil.getDescriptor("Images.ExportToClipBoardIcon"));
	}
