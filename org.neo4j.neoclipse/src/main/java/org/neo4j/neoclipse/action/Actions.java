...
public enum Actions
{
    ...
    NODE_ID( "Node id" ),
    NODE_LABELS( "Node property values" ),
    NODE_PROPERTY_KEYS( "Node property keys" ),
    NODE_PROPERTY_FILTERED( "Filter node properties" ),
    // view relationships settings
    RELATIONSHIP_COLORS( "Relationship colors" ),
    RELATIONSHIP_DIRECTIONS( "Relationship directions" ),
    RELATIONSHIP_ID( "Relationship id" ),
    RELATIONSHIP_LABELS( "Relationship property values" ),
    RELATIONSHIP_PROPERTY_KEYS( "Relationship property keys" ),
    RELATIONSHIP_PROPERTY_FILTERED( "Filter relationship properties" ),
